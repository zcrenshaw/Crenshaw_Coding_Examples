...
public class DisplayObject {
	...
	/* Private reference to this Display Object */
	...
	public Point localToGlobal (Point p) {
		...
		if (parent != null) {
			p.x = p.x + parent.localToGlobal(parent.getPosition()).x;
			p.y = p.y + parent.localToGlobal(parent.getPosition()).y;
		}
	...
	public Point globalToLocal (Point p) {
		...
		if (parent != null) {
			p.x = p.x - parent.globalToLocal(parent.getPosition()).x;
			p.y = p.y - parent.globalToLocal(parent.getPosition()).y;
		}
	...
	public Point parentToLocal (Point p) {

		DisplayObject parent = this.getParent();

		if (parent != null) {
			p.x = p.x - parent.getPosition().x;
			p.y = p.y - parent.getPosition().y;
		}
