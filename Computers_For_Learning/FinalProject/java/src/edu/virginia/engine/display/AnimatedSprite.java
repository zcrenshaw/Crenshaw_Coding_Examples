...
public class AnimatedSprite extends Sprite {
    ...
    public AnimatedSprite(String id, String filename, Point pos) {
        ...
        Animation launch = new Animation("launch",1,3);
    ...
    public void initFrames(){
        ...
        this.frames.add(this.readImage("rocket.png"));
        this.frames.add(this.readImage("rocket_fire1.png"));
        this.frames.add(this.readImage("rocket_fire2.png"));
        this.frames.add(this.readImage("rocket_fire3.png"));
