...
(define (board->image board)
  (match board
    ['() empty-image]
    [(cons first rest) (populate-board 30 8 8 0 board "peru" "beige")]))

(: board->image-variable : Board Integer -> Image)
;;makes an image out of the board
(define (board->image-variable board size)
  (match board
    ['() empty-image]
