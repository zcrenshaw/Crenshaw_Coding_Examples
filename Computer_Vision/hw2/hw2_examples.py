...
# img0 = load_image('data/halfdome/halfdome-01.png')
# img1 = load_image('data/halfdome/halfdome-02.png')
...
# img0 = load_image('data/original.png')
# img1 = load_image('data/cropped.png')
...
#matches, match_scores = match_features(feats0, feats1, scores0, scores1,'naive')
matches, match_scores = match_features(feats0, feats1, scores0, scores1,'kdtree')

threshold = -1 # adjust this for your match scoring system
